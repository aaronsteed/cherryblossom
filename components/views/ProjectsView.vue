<template>
  <div class="pb-20">
    ...
    <h1
      class="flex flex-col desktop:text-7xl tablet:text-6xl mobile:text-4xl font-bold text-center justify-center items-center text-black pt-24 pb-20"
    >
      Projects
    </h1>
    <div v-if="!isSmallScreen" class="flex justify-center space-x-40">
      <project-card
        ...
        project-description="The site you're currently looking at. All open source and ready to be critiqued"
