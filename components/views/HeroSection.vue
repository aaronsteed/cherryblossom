<template>
  <div
    class="min-w-screen min-h-screen h-screen w-screen bg-[#EDF2F4] desktop:px-40 px-5"
  >
    <div v-if="!isSmallScreen" class="h-screen flex items-center">
      <div class="flex h-64 flex-row text-5xl">
        <img
        ...
        <div class="desktop:text-7xl tablet:text-4xl mobile:text-2xl font-bold">
          <h1 class="bg-[#2B2D42] p-4 text-[#EDF2F4] shadow-sm">
            Hi! 👋 I'm Aaron Steed.
          </h1>
          <div class="p-2"></div>
          <h1
          ...
          <div class="flex flex-row">
            <div
              class="bg-[#2B2D42] p-4 text-white desktop:text-lg tablet:text-sm mobile:text-sm font-weight-light w-3/6 shadow-sm"
            >
              ...
              <span class="text-[#8D99AE]">reading</span>,
    ...
    <div v-if="isSmallScreen" class="">
      <div class="flex h-64 flex-col text-5xl pt-64">
        ...
        <div class="mobile:text-2xl font-bold">
          ...
          <div class="p-2"></div>
          <h1 class="bg-[#2B2D42] mobile:text-2xl p-4 text-[#EF233C] w-9/12">
            {{ roles }}
          </h1>
          <div class="p-2"></div>
          <div class="flex flex-row">
...
<style scoped>
.hero-landing {
  background: linear-gradient(-45deg, #12238d, #ff0433, #12238d, #ff002d);
