  ...
  >
    ...
    <div class="p-6 pt-0">
      <button
        ...
        type="button"
        class="flex flex-row select-none rounded-lg bg-blue-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        @click="clicked"
      >
        <p>Github</p>
        <Icon name="tdesign:jump" size="17" class="ml-2"></Icon>
      </button>
    </div>
  </div>
</template>
